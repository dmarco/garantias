        ...
        <v-dialog v-model="dialog" max-width="340">
          <v-card>
            ...
            <v-card-text class="py-0">
              <v-chip :color="statusAlert" text-color="white" label class="mx-0 my-0"><v-icon left>label</v-icon>{{ status }}</v-chip>
            </v-card-text>
            ...
            <v-card-actions>
              <v-spacer></v-spacer>
              <v-btn :color="statusAlert" class="ma-3" outline @click.native="dialog = false">Cerrar</v-btn>
            </v-card-actions>
          </v-card>
        </v-dialog>
      </v-layout>
